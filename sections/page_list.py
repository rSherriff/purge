...
import gzip
import tile_types
from ui.page_list_ui import PageListUI
import os.path
from application_path import get_app_path

xp_filepath = get_app_path() + '/images/page_list.xp'


class PageList(Section):
    def __init__(self, engine, x, y, width, height):
        ...
        self.ui = PageListUI(self, x, y, self.tiles['graphic'])
